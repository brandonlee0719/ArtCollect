...
class ArtCollect_Token(FA2.FA2):
    pass


class ArtCollect_Marketplace(sp.Contract):
...
def test():
    ...
    scenario += marketplace.mint(sp.record(royalties = 5, metadata = sp.pack("123423"))).run(sender = vera, amount = sp.mutez(100))
